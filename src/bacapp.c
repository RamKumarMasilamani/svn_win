    ...
    if (object_value && object_value->value) {
        ...
        switch (value->tag) {
            ...
            //printf(" - case BACNET_APPLICATION_TAG_OCTET_STRING - ");
                ...
                break;
            case BACNET_APPLICATION_TAG_CHARACTER_STRING:
            //printf(" - case BACNET_APPLICATION_TAG_CHARACTER_STRING - ");
                ...
                break;
            case BACNET_APPLICATION_TAG_BIT_STRING:
            //printf(" - case BACNET_APPLICATION_TAG_BIT_STRING - ");
                ...
                break;
            case BACNET_APPLICATION_TAG_ENUMERATED:
             //printf(" - case BACNET_APPLICATION_TAG_ENUMERATED - ");
                switch (property) {
                ...
                break;
            case BACNET_APPLICATION_TAG_DATE:
            //printf(" - case BACNET_APPLICATION_TAG_DATE - ");
                if (!append_str(&p_str, &rem_str_len,
                ...
                break;
            case BACNET_APPLICATION_TAG_TIME:
            //printf(" - case BACNET_APPLICATION_TAG_TIME - ");
                ...
                break;
            case BACNET_APPLICATION_TAG_OBJECT_ID:
            //printf(" - case BACNET_APPLICATION_TAG_OBJECT_ID - ");
                if (!append_str(&p_str, &rem_str_len, "("))
                    break;
